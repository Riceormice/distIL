...
The four lanes run GRPO, SDPO, OPSD, and SR-OPSD, respectively. GRPO now uses
the repaired OPSD/TRL implementation; SDPO and SR-OPSD keep native VERL. All lanes
...
temperature/top-p/top-k 0.7/0.95/20, and LoRA rank 64. Every method uses eight
questions and eight rollouts, for 64 generated trajectories per optimizer step.
...
results and local training logs remain under method-specific roots. The
restored GRPO root is
`/media/vlm-ckp-fileset/ylong/math_grpo_4b_opsd_trl_aligned_eval5_n16_a800_20260827`.
