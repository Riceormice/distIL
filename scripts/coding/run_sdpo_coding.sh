#!/bin/bash
# scripts/coding/run_sdpo.sh
# Train SDPO baseline on LiveCodeBench (LCBv6) with rich execution feedback.
# Paper: Table 3 (Coding column) hyperparameters.
#
# Usage:
#   bash scripts/coding/run_sdpo.sh [--dry-run]
...
# =============================================================================
# EXPERIMENT CONFIGURATION (Table 3, Coding column)
# =============================================================================
CONFIG_NAME="sdpo"
...
EXP_NAME="SDPO-coding-lcbv6-${MODEL_NAME}"

args="data.train_batch_size=${TRAIN_BATCH_SIZE} \
trainer.group_name=SDPO-coding \
