...
exec env \
  ...
  KEEPALIVE_MIN_UTILIZATION="${KEEPALIVE_MIN_UTILIZATION:-38}" \
  KEEPALIVE_BURST_SECONDS="${KEEPALIVE_BURST_SECONDS:-0.7}" \
  KEEPALIVE_IDLE_SECONDS="${KEEPALIVE_IDLE_SECONDS:-0.8}" \
  KEEPALIVE_STARTUP_DELAY_SECONDS="${KEEPALIVE_STARTUP_DELAY_SECONDS:-30}" \
  KEEPALIVE_MATRIX_SIZE="${KEEPALIVE_MATRIX_SIZE:-2048}" \
  KEEPALIVE_MIN_USED_MEMORY_MIB="${KEEPALIVE_MIN_USED_MEMORY_MIB:-4096}" \
